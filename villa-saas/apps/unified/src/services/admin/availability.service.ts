...
class AvailabilityService {
  ...
  async getBlockedPeriods(params: {
    ...
    return apiClient.get<BlockedPeriod[]>(`/api/availability/blocked-periods?${queryString}`);
  }
  ...
  async getAvailabilityCalendar(params: {
    ...
    const queryString = new URLSearchParams(params as any).toString();
    return apiClient.get<AvailabilityCalendar>(`/api/availability/availability-calendar?${queryString}`);
  }
