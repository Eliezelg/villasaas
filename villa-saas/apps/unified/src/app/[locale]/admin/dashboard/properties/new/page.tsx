...
import { LocationForm } from '@/components/admin/property/simple-location-form';
import { AmenitiesForm } from '@/components/admin/property/amenities-form';
  ...
  async function onSubmit(data: FormData) {
    ...
    try {
      ...
      if (property) {
        ...
        // Stocker l'ID de la propriété pour l'onboarding
