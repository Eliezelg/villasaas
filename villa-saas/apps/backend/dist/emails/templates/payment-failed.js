...
const PaymentFailedEmail = ({ locale, guestName, bookingReference, propertyName, checkIn, checkOut, totalAmount, currency = 'EUR', tenantName = 'Villa SaaS', tenantLogo, retryUrl, }) => {
    ...
    return (React.createElement(base_email_1.BaseEmail, { previewText: previewText, tenantName: tenantName, tenantLogo: tenantLogo, footer: i18n.t('emails.paymentFailed.footer', { tenantName }) },
        React.createElement(components_1.Heading, { style: base_email_1.styles.h1 }, i18n.t('emails.paymentFailed.title')),
        React.createElement(components_1.Text, { style: base_email_1.styles.text }, i18n.t('emails.paymentFailed.greeting', { guestName })),
        React.createElement(components_1.Text, { style: base_email_1.styles.text }, i18n.t('emails.paymentFailed.intro')),
        ...
        React.createElement(components_1.Section, { style: base_email_1.styles.warningSection },
            React.createElement(components_1.Text, { style: base_email_1.styles.warningText }, i18n.t('emails.paymentFailed.warning'))),
        retryUrl && (React.createElement(components_1.Section, { style: base_email_1.styles.buttonSection },
            React.createElement(components_1.Button, { style: base_email_1.styles.button, href: retryUrl }, i18n.t('emails.paymentFailed.retryButton')))),
        React.createElement(components_1.Text, { style: base_email_1.styles.text }, i18n.t('emails.paymentFailed.contact'))));
};
