...
const user_invitation_1 = __importDefault(require("../../emails/templates/user-invitation"));
...
async function userRoutes(fastify) {
    // List users
    fastify.get('/', {
        preHandler: [fastify.authenticate, (0, rbac_middleware_1.requirePermission)('users.read')],
    }, async (request, reply) => {
    ...
    // Create user
    fastify.post('/', {
        preHandler: [fastify.authenticate, (0, rbac_middleware_1.requirePermission)('users.write')],
        schema: {
            body: {
                type: 'object',
    ...
    // Delete user
    fastify.delete('/:id', {
        preHandler: [fastify.authenticate, (0, rbac_middleware_1.requirePermission)('users.delete')],
    }, async (request, reply) => {
        const tenantId = (0, utils_2.getTenantId)(request);
        const { id } = request.params;
    ...
    fastify.post('/invite', {
        ...
        const passwordHash = await (0, utils_1.hashPassword)(temporaryPassword);
        ...
        try {
            ...
            const emailHtml = await (0, components_1.render)((0, user_invitation_1.default)({
                firstName,
                email,
                temporaryPassword,
                role,
